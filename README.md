...
Building a semantically searchable knowledge base that can be queried by meaning and not just keywords should be a top priority for every business. 

Every document gets added. Every email where someone explained how something worked. Every conversation that solved a problem.
All of it should live in a system where you can search by what you mean, not just what you type.
