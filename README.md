...
higher dimensional space. all-MiniLM-L6-v2 returns 384 dimensions. 

I used it to calculate the position of 100 Yoda quotes:

"Fear is the path to the dark side". 
-> [0.060235,0.017227,-0.001324,0.151363, ...]

"Always pass on what you have learned"
-> [0.054547,0.016146,-0.013533,0.015499, ...]

All of these were added to a vector database (PostgreSQL database with the pgvector extension)

I came up with a question, passed it through the same embedding model, and then asked the database to return the quote who's vector was the shortest distance from the semantic position of my question:
